""" Base class for projection-based NACT models."""

from ._base_model import NACTBaseModel
...
class NACTBaseProjectionModel(NACTBaseModel):
    """ Base model for the projection-based NACT model.
