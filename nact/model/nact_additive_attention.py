"""Implementation of NACT with additive attention."""

from .base._base_model import NACTBaseModel
from .base._constants_and_types import _DEVICE_TYPES

import torch


class NACTAdditiveModel(NACTBaseModel):
    """Implementation of additive attention + NACT from base class.
