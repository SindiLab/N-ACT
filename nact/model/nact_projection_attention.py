"""Implementation of NACT model with attention + projection blocks."""

from .base._base_projection_model import NACTBaseProjectionModel
from .base._constants_and_types import _DEVICE_TYPES
import torch


class NACTProjectionAttention(NACTBaseProjectionModel):
    """NACT model with attention and projection blocks.
    ...
    def __init__(self,
        ...
        # NACT Components are as follows:
    ...
    def forward(self,
                ...
                training: bool = True,
                device='cpu'):
        """Forward pass of the projection-based NACT model.
